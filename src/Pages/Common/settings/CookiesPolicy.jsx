...
import CookiesPolicyForUsers from "./CookiesPolicyForUsers";
import CookiesPolicyForBusiness from "./CookiesPolicyForBusiness";
...
const CookiesPolicy = () => {
  ...
  return (
    ...
    >
      ...
      {activeTab === "regularUser" ? (
        <CookiesPolicyForUsers />
      ) : (
        <CookiesPolicyForBusiness />
      )}
    </div>
  );
};
