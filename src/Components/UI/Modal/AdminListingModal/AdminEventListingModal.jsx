    ...
    >
      <div className="mt-7">
        ...
        <div>
          ...
          <div className="mt-4">
            <p className="text-lg lg:text-xl font-bold mb-3">Description</p>
            <p className="text-sm sm:text-base lg:text-lg">
              Elegant, handcrafted floral arrangements for every occasion! 💐
              From stunning bouquets to premium artificial blooms, we create
              beauty that lasts. Delivered with love, always! ✨🌸{" "}
            </p>
          </div>

          <div className="mt-4">
            <p className="text-lg lg:text-xl font-bold mb-3">Gallery</p>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <img
                src={AllImages.flower}
                alt="cover"
